// server/lib/cascade-provider.cjs — Unified provider via Free Proxy :20130 + Ollama
...
const FREE_PROXY_URL = process.env.FREE_PROXY_URL || 'http://localhost:20130/v1';
...
/**
 * Call Free Models Proxy (:20130) — OpenAI-compatible API
