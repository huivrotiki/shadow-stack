...
const gateway = new LLMGateway({
  providers: [
    ...
    },
    {
      ...
      timeout: 10000,
      modelMap: {
        // Active models (verified 2026-04-07)
        ...
        'gr-allam':          'allam-2-7b',
        // Removed: llama3-70b-8192, llama3-8b-8192, mixtral-8x7b-32768, gemma-7b-it, gemma2-9b-it, llama-guard-3-8b (decommissioned)
      }
    },
    {
      id: 'mistral',
...
const MODEL_MAP = {
  ...
  // Groq models (verified 2026-04-07 with API)
  ...
  'gr-compound-mini':  { provider: 'groq',     model: 'groq/compound-mini',                         priority: 1 },
  'gr-whisper':        { provider: 'groq',     model: 'whisper-large-v3',                           priority: 1 },
  'gr-whisper-turbo':  { provider: 'groq',     model: 'whisper-large-v3-turbo',                     priority: 1 },
  'gr-allam':          { provider: 'groq',     model: 'allam-2-7b',                                 priority: 1 },
  // Removed deprecated: gr-llama3-70b, gr-llama3-8b, gr-mixtral, gr-gemma-7b, gr-gemma2-9b, gr-llama-guard, gr-qwen3
