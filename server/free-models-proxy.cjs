  ...
  providers: [
    ...
    },
    {
      ...
      modelMap: {
        ...
        // Gemini direct (free via OmniRoute)
...
const MODEL_MAP = {
  ...
  // OmniRoute Kiro (requires API key)
...
const CASCADE_CHAIN = [
  ...
  // 'omni-sonnet',        // ❌ OmniRoute API key required
  // OmniRoute Free Tiers (via :20130)
  ...
  'kc-step-flash',      // Tier 0d — StepFun Flash (OmniRoute free)
  'kc-trinity',         // Tier 0e — Trinity Large (OmniRoute free)
