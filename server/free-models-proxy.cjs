  ...
  providers: [
    ...
    },
    {
      ...
      modelMap: {
        ...
        'gr-llama3-70b':  'llama3-70b-8192',
        'gr-llama3-8b':   'llama3-8b-8192',
        ...
        'gr-mixtral':     'mixtral-8x7b-32768',
        'gr-gemma-7b':    'gemma-7b-it',
        'gr-gemma2-9b':   'gemma2-9b-it',
        'gr-llama-guard': 'llama-guard-3-8b',
      }
    },
    {
      id: 'mistral',
...
const MODEL_MAP = {
  ...
  'gr-llama3-70b':  { provider: 'groq',     model: 'llama3-70b-8192',                            priority: 1 },
  'gr-llama3-8b':   { provider: 'groq',     model: 'llama3-8b-8192',                             priority: 1 },
  ...
  'gr-mixtral':     { provider: 'groq',     model: 'mixtral-8x7b-32768',                         priority: 1 },
  'gr-gemma-7b':    { provider: 'groq',     model: 'gemma-7b-it',                                priority: 1 },
  'gr-gemma2-9b':   { provider: 'groq',     model: 'gemma2-9b-it',                               priority: 1 },
  'gr-llama-guard': { provider: 'groq',     model: 'llama-guard-3-8b',                           priority: 1 },
